...
K2100M_ROM_SHA256SUM="554771749c6308a680dbb5d7bfe9c05be9b3f43accb1ed33efab6cfbec0b4133  vbios_10de_11fc_1.rom"
K1100M_ROM_SHA256SUM="d70500fd0d9a34739fc5d45a4fcf040d2a78c17ae16e7148a08b1cfcd6259411  vbios_10de_0ff6_1.rom"
...
cd output
echo "$K2100M_ROM_SHA256SUM" | sha256sum --check || { echo "K2200M rom failed sha256sum verification..." && exit 1; }
echo "$K1100M_ROM_SHA256SUM" | sha256sum --check || { echo "K1100M rom failed sha256sum verification..." && exit 1; }
...
sudo mv vbios_10de_0ff6_1.rom "$BLOBDIR"/10de,0ff6.rom
